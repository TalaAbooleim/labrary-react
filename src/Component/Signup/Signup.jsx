...
const Signup = () => {
  ...
  ///can you navicate between route
  const navigate = useNavigate();

///set for update the data
  const handleInputChange = (e) => {
    setFormData({ ...formData, [e.target.name]: e.target.value });
  };
  //// used to track the overall validity of the form.
  const validateForm = () => {
    let isValid = true;
    const newErrors = {};
  ...
  const handleSubmit = (e) => {
    /// to prevent the default action associated with the event.
    e.preventDefault();
  ...
  return (
    <div className="container-signup">
     <img src={'https://th.bing.com/th/id/R.781b2d132fc82b6d5e509cc571fe412b?rik=%2baGO6A6kV2I5NQ&pid=ImgRaw&r=0'} alt="login" className="img" />
        ...
        <div className="mb-3">
          <input
            ...
            className={`form-control ${
              errors.email || emailExists ? "is-invalid" : ""
            }`}
          />
          {errors.email && (
